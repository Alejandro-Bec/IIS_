...
void agregarProducto(Cliente lista[], int total);
...
void buscarCliente(Cliente lista[], int total) {
    ...
    for (int i = 0; i < total; i++) {
        ...
        if (strcmp(busca, lista[i].nombre) == 0) {
            ...
            float restante = lista[i].venta - sumaAbonos;
...
void agregarProducto(Cliente lista[], int total){
    ...
    printf("A quien deseas agregarle productos: ");
    printf("--------------------------------------\n");
    ...
    for(int j = 0; j < numProd; j++){
        ...
        fgets(c->nuevoProducto, sizeof(c->nuevoProducto), stdin);
        c->nuevoProducto[strcspn(c->nuevoProducto, "\n")] = '\0';
